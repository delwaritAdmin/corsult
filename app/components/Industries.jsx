        ...
        <div className="container mx-auto px-4">
          <div className="p-6 grid grid-cols-1 gap-8 lg:grid-cols-5 lg:items-center lg:gap-0 lg:gap-x-8">
            ...
            rounded-xl lg:col-span-2">
              ...
              <p className="leading-[24px]  text-sm text-white pt-3">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="grid grid-cols-2 gap-5 md:grid-cols-3 lg:grid-cols-4">
                ...
                shadow-md  rounded-[16px] p-4 

                lg:py-6 flex flex-col gap-2 items-center cursor-pointer   hover:bg-primary  transition-all duration-300 overflow-hidden hover:text-white text-[#027EEC]">
                ...
                <div className="bg-[#17191D]  shadow-md  rounded-[16px] p-4 lg:py-6 flex flex-col gap-2 items-center cursor-pointer   hover:bg-primary  transition-all duration-300 overflow-hidden hover:text-white text-[#027EEC]">
                  <div className="bg-[#eaf3ff] p-5 rounded-xl">
                ...
                <div className="bg-[#17191D]   shadow-md  rounded-[16px] p-4 lg:py-6 flex flex-col gap-2 items-center cursor-pointer   hover:bg-primary  transition-all duration-300 overflow-hidden hover:text-white text-[#027EEC]">
                  ...
                  <Link
                    href={"#"}
                    className=" text-white font-semibold transition-all durat ion-200 "
                  >
                    Legal
                  </Link>
                </div>
