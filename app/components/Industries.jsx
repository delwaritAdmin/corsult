          ...
          <div className="p-6 grid grid-cols-1 gap-8 lg:grid-cols-5 lg:items-center lg:gap-0 lg:gap-x-8">
            ...
            <div className="lg:col-span-3">
              <div className="grid grid-cols-2 gap-5 md:grid-cols-3 lg:grid-cols-4">
                <div className="bg-white  customShad rounded-[16px] p-4 lg:py-6 flex flex-col gap-2 items-center cursor-pointer hvr-bounce-to-left overflow-hidden hover:text-white text-[#027EEC]">
